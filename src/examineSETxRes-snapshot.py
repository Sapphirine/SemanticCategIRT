...
sc = SparkContext(appName='corpus-tf-idf')
...
def distributed_ops( corpus, sanit=False, recall=False, corpreduce=False, streams=False, \
                     segred=False, tfidf=False, lda=False, word2vec=False, filename=None):
...
if __name__ == "__main__":
    ...
    filename = '../corpora-proc/human_cloning.txt'
    ...
    sanit_text, corpus_unique_dict, counts, cluster_lab = \
        distributed_ops(corpus,recall=True,corpreduce=True)
    # Random checker #
