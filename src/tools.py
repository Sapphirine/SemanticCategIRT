# https://github.com/alexalemi/segmentation/blob/master/code/tools.py
"""
...
# with open("/Users/samimourad/cloaked-robot/local/segmentation/data/STOPWORD.list") as f:
#     for line in f:
#         stopword_set.add(line.strip())
# # add punctuation
# stopword_set.update(["''",",",".","``","'","!",'"',"#","$","%","&","(",")","*","+","-","/",
#     ":",";","<","=",">","?","@","[","\\","]","^","_","`","{","|","}","~"])
from precompiledRegex import stopword_set
